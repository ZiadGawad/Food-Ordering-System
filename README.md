...
A personal project built to practice OOP principles, problem-solving, and basic software engineering concepts using a real-world food ordering scenario

## Overview
This project simulates a simple food ordering system where users can view menu items, place orders, and manage basic order logic.
The focus is on clean code, clarity, and correct program flow.
...
- Save Drivers Statistics to text file
...
- Using Git and GitHub to track and publish a project
